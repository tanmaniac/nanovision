"""Decoder-only character LM assembled from the A1 transformer (provided glue).

This assembly is given to you; the interesting work is in the blocks it composes
(Tasks 1-7). Once those are filled, the overfit-copy test drives this model to ~0.
...
attention, so there is no separate positional-encoding module.
"""
